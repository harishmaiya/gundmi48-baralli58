...
<tr>
<th style=\"color: #000; padding: 0px 20px; font-family: Open Sans, Arial, Helvetica, sans-serif; font-size: 13px;\" align=\"center\"><span>The h</span>ost <span>'.$hostname.'&nbsp;</span>have declined your reservation for&nbsp;<span>'.$propertyname.'</span>. Kindly find alternative accomodation at <a href=\"'.base_url().'\">'.base_url().'</a>. We look forward for your next booking.&nbsp;</th>
</tr>
<tr>
<td>&nbsp;</td>
</tr>
