...
<tr>
<td style=\"color: #000; padding: 0px 20px; font-family: Open Sans, Arial, Helvetica, sans-serif; font-size: 13px;\" align=\"center\">We\'re excited to tell you that, your '.$rental_name.' is booked for the booking # '.$bookingNo.'. To help make check-in seamless, we suggest you continue the conversation with your guest '.$first_name.' '.$last_name.'</td>
</tr>
<tr>
...
<tr>
<td style=\"color: #4f595b; font-family: Open Sans, Arial, Helvetica, sans-serif; font-size: 13px; line-height: 20px; padding: 0px 20px;\" align=\"left\" valign=\"top\" width=\"300px\">'.$service.'
