...
(function($){
    $.fn.DOPBackendBookingCalendarPRO = function(options){
        ...
        var Data = {'AddtMonthViewText': 'Add Month View', // Add Month View button title (plus icon).
                    ...
                    'Currency': currencytype, // Currency icon.
        ...
        methods = {            
                    ...
                    initCalendar:function(){// Init  Calendar
                        ...
                        HTML.push('        </div>');
                        HTML.push('        <div class="add_btn" title="'+AddtMonthViewText+'"><div class="addicon">+</div></div>');                        
                    ...
                    showForm:function(){// Show Form
                        ...
                        HTML.push('                <input type="text" name="DOPBCP_price" id="DOPBCP_price" value="'+bookprice+'" /><span class="currency">'+currencytype+'</span>');
                        HTML.push('                <br class="DOPBackendBookingCalendarPRO_Clear" />');
