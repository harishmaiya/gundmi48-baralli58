...
<div class="top-listing-head">
 ...
 <div id="example-two">
        ...
        <ul class="nav">
                <li class="nav-one"><a href="<?php echo base_url().'inbox';?>" class="current"><?php if($this->lang->line('Inbox') != '') { echo stripslashes($this->lang->line('Inbox')); } else echo "Inbox";?></a></li>
                <li class="nav-two"><a href="<?php echo base_url().'sentbox';?>" ><?php if($this->lang->line('Sent') != '') { echo stripslashes($this->lang->line('Sent')); } else echo "Sent";?></a></li>
        </ul>
...
//$this->data ['userdetail'] = $this->cms_model->get_all_details (USERS, array ('id' => $InboxStr->guide_id));
                                            ...
                                            <td><?php echo $InboxStr->message; ?></td>
                                            <td><?php echo $InboxStr->date_created; ?></td>
                                            <td><div class="edit"><a href="site/user_settings/view_inquiry_details/<?php echo $InboxStr->convId;?>"><?php if($this->lang->line('viewmessage') != '') { echo stripslashes($this->lang->line('viewmessage')); } else echo "view message";?></a></div>
