  		...
  		<div class="popup_page">
            ...
            <div class="popup_detail">
            	<div class="banner_signup">
					...
					<input type="password" id="password" value=""  placeholder="<?php if($this->lang->line('signup_password') != '') { echo stripslashes($this->lang->line('signup_password')); } else echo "Password"; ?>" class="decorative-input1" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" onkeyup="return CheckPasswordStrength(this.value);"/>
					 <div id="password_strength" style="text-align: left;"></div>
...
$(document).ready(function(){
	initializeMap();
	if($('#autocompleteNewMoblie').length)initializeMapMobile();
...
$(function(){
	...
	$('#autocompleteNew123').keyup(function()
	{
