              ...
              <ul>
                ...
                <li>
                  <div class="form_grid_12">
                    ...
                    <div class="form_input">
                      <input name="page_title" id="page_title" type="text" tabindex="2" class="required large tipTop" title="Please enter the page title"/>
                    </div>
                  </div>
                </li>
				<!--<li>
                ...
                <li>
                  <div class="form_grid_12">
                    ...
                    <div class="form_input">
                      <textarea name="description" tabindex="3" class="required large tipTop mceEditor" title="Please enter the page content"></textarea>
                    </div>
                  </div>
                </li>
                <li>
