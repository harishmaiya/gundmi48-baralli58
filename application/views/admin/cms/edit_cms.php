            ...
            <div id="tab1">
              ...
              <?php if ($cms_details->row()->category == 'Sub'){?>
               ...
               <?php }?>
                ...
                <li>
                  <div class="form_grid_12">
                    <label class="field_title" for="page_title">Page Title <span class="req">*</span></label>
                    <div class="form_input">
                      <input name="page_title" id="page_title" type="text" value="<?php echo $cms_details->row()->page_title;?>" tabindex="3" class="required large tipTop" title="Please enter the page title"/>
                    </div>
                  </div>
                </li>
				<!--<li>
                  <div class="form_grid_12">
                    ...
                    <div class="form_input">
					  ...
					  <option <?//if($cms_details->row()->section == 'discover')echo 'selected="selected"';?> value="discover">Discover</option>
					  <option <?//if($cms_details->row()->section == 'company')echo 'selected="selected"';?> value="company">Company</option>
					  </select>
                    </div>
                  </div>
                </li>-->
                <li>
                  <div class="form_grid_12">
                    ...
                    <div class="form_input">
                      <textarea name="description" tabindex="4" class="required large tipTop mceEditor" title="Please enter the page content"><?php echo $cms_details->row()->description;?></textarea>
                    </div>
                  </div>
                </li>
              </ul>
