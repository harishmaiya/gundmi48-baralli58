				...
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<div class="btn_30_light" style="height: 29px;">
								<a href="admin/cms/add_lang_page" class="tipTop" title="Select any checkbox and click here to active records"><span class="icon add_co"></span><span class="btn_link">Add other Language</span></a>
							</div>
							<div class="btn_30_light" style="height: 29px;">
