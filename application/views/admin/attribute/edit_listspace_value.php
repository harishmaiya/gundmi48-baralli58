				...
				<div class="widget_wrap">
					...
					?>
						...
						<ul>
							...
							<div class="form_input">
								<input name="list_value" value="<?php echo $list_value_details->row()->list_value;?>" id="list_value" type="text" tabindex="1" class="required large tipTop" maxlength="30" title="Please enter the list value"/>
							</div>
							</div>
							</li>
							<li>
							<div class="form_grid_12">
							<label class="field_title" for="list_description">List Description</label>
							<div class="form_input">
								<input name="list_description" maxlength="30" value="<?php echo $list_value_details->row()->list_description;?>" id="list_description" type="text" tabindex="1" class=" large tipTop" title="Please enter the list value"/>
							</div>
							</div>
							</li>
