...
<script type="text/javascript" src="<?php echo base_url();?>js/1.10.min.js"></script>
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>css/admin_booking_calender.css">
</head>
<body>
<div id="wrapper">
	<div id="monthly_calender">
		<div class="calender-container-detail calender-container">
			<div class="calenderholder" id="slide-calendar">
		...
		<script type="text/javascript">
		$( document ).ready(function() {
			$('.date-unavailable .dayholder').append( '<div class="nlhalf-detail"></div>' );
			$('.date-unavailable').next().find('.dayholder').append( '<div class="nrhalf"></div>' );
			$('.date-available .dayholder').append( '<div class="alhalf-detail"></div>' );
			$('.date-available').next().find('.dayholder').append( '<div class="arhalf"></div>' );
			$('.date-booked .dayholder').append( '<div class="blhalf-detail"></div>' );
		...
		$.ajax({
		type:'POST',
		url:'<?php echo base_url();?>site/rentals/Send_email',
		data:{'email_address':email_address,'messages':messages,'productId':productId},
		success:function(data){
		alert(data);
							}
		});
