				...
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						<tr>
							...
							?>
								<span class="badge_style b_done"><a href="<?php base_url();?>admin/location/change_location_status/InActive/<?php echo $row->id;?>">Active</a></span>
							<?php
								}else {	
							?>
								<span class="badge_style"><a href="<?php base_url();?>admin/location/change_location_status/Active/<?php echo $row->id;?>">InActive</a></span>
							<?php 
								}
							}else {
							?>
