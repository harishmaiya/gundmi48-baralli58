                    	...
                    	<div id="tab1">
	 						<ul>
								...
								<div class="form_grid_12">
                                    ...
                                    <input name="name" style=" width:295px" id="name" value="<?php echo $city_details->row()->name; ?>" type="text" tabindex="1" class="required tipTop" title="Please enter the city" onblur="javascript:getAddressDetails(this);"/>
									</div>
								</div>
								</li>
								<li>
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <input name="state_name" value="<?php echo $city_details->row()->state_name; ?>" style=" width:295px" id="stateid" value="" type="text" tabindex="1" class="required tipTop" title="Please enter the state" />
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <input name="country_name" value="<?php echo $city_details->row()->country_name; ?>" style=" width:295px" id="countryid" value="" type="text" tabindex="1" class="required tipTop" title="Please enter the country" />
              ...
              <ul>
                ...
                <li>
                  <div class="form_grid_12">
                    ...
                    <div class="form_input">
                      <textarea name="meta_keyword" id="meta_keyword" style="width:50%;"  tabindex="2" class="large tipTop" title="Please enter the page meta keyword"><?php echo $city_details->row()->meta_keyword;?></textarea>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="form_grid_12">
                    ...
                    <div class="form_input">
                      <textarea name="meta_description" id="meta_description" style="width:50%;"  tabindex="3" class="large tipTop" title="Please enter the meta description"><?php echo $city_details->row()->meta_description;?></textarea>
                    </div>
                  </div>
                </li>
              </ul>
