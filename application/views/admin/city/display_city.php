			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						?>
							<div class="btn_30_light" style="height: 29px;">
								<a href="admin/city/add_city_form" class="tipTop" title="Click here to add List Value"><span class="icon add_co"></span><span class="btn_link">Add New</span></a>
							</div>
						<?php }?>
						</div>
					</div>
